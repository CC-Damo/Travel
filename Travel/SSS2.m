                ...
                if (error == nil)
                {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        if(serviceTag.count <= 0){
                            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops!" message:@"No Busses currently avalable!" delegate:self cancelButtonTitle:@"Dismiss" otherButtonTitles: nil];
                            [alert show];
                        }
