...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    Step3Data *step3data = [Step3Data sharedManager];
    step3data.stopNo = [stopNumbers objectAtIndex:indexPath.row];
    step3data.title = [stopNames objectAtIndex:indexPath.row];
    NSLog(@"Stop number: %@", step3data.stopNo);
}
